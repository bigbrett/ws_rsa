set C_TypeInfoList {{ 
"ModExp" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"M": [[],"0"] }, {"e": [[],"0"] }, {"n": [[],"0"] }, {"Mbar": [[],"0"] }, {"xbar_in": [[],"0"] }, {"out": [[],{ "pointer": "0"}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "M_V", "interface" : "wire", "bitwidth" : 1024, "direction" : "READONLY", "bitSlice":[{"low":0,"up":1023,"cElement": [{"cName": "M.V","cData": "uint1024","bit_use": { "low": 0,"up": 1023},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "xbar_in_V", "interface" : "wire", "bitwidth" : 1024, "direction" : "READONLY", "bitSlice":[{"low":0,"up":1023,"cElement": [{"cName": "xbar_in.V","cData": "uint1024","bit_use": { "low": 0,"up": 1023},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ xbar_in_V sc_in sc_lv 1024 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "xbar_in_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "xbar_in_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "ModExp", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		...
		{"Name" : "xbar_in_V", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		...
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ModExp_montMult_fu_95", "Parent" : "0", "Child" : ["2", "3", "4"], "CDFG" : "ModExp_montMult", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ModExp_montMult_fu_95.ModExp_add_1026ns_1026ns_1026_2_U1", "Parent" : "1", "Child" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ModExp_montMult_fu_95.ModExp_sub_1024ns_1024ns_1024_2_U2", "Parent" : "1", "Child" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ModExp_montMult_fu_95.ModExp_add_1026ns_1026ns_1026_2_U3", "Parent" : "1", "Child" : []}]}
...
set Spec2ImplPortList { 
	...
	xbar_in_V { ap_none {  { xbar_in_V in_data 0 1024 } } }
