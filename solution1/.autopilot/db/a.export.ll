; ModuleID = '/home/brett/Thesis/Vivado_WS/ws_rsa/solution1/.autopilot/db/a.o.2.bc'
...
define void @rsaModExp(i2048 %M_V, i2048 %e_V, i2048 %n_V, i2048* %out_V) {
  ...
  %tmp_i = zext i2048 %n_V_read to i2052
  %tmp_i_5 = zext i2048 %M_V_read to i2052
  br label %1

; <label>:1                                       ; preds = %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i, %0
  %p_Val2_s = phi i2052 [ 0, %0 ], [ %P_V_5, %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i ]
  %i_assign_1 = phi i13 [ 2048, %0 ], [ %i_1, %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i ]
  %i_assign_1_cast = sext i13 %i_assign_1 to i32
  %tmp = call i1 @_ssdm_op_BitSelect.i1.i13.i32(i13 %i_assign_1, i32 12)
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2049, i64 2049, i64 2049)
  br i1 %tmp, label %interleaveModMult.exit, label %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i
...
_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i: ; preds = %1
  ...
  %P_V_1 = add i2052 %r_V, %tmp_i_5
  %P_V_2 = select i1 %tmp_3, i2052 %P_V_1, i2052 %r_V
  %tmp_4_i = icmp ult i2052 %P_V_2, %tmp_i
  %P_V_3 = sub i2052 %P_V_2, %tmp_i
  %p_036_1_P_V_2_i = select i1 %tmp_4_i, i2052 %P_V_2, i2052 %P_V_3
  %tmp_5_i = icmp ult i2052 %p_036_1_P_V_2_i, %tmp_i
  %P_V_4 = sub i2052 %p_036_1_P_V_2_i, %tmp_i
  %P_V_5 = select i1 %tmp_5_i, i2052 %p_036_1_P_V_2_i, i2052 %P_V_4
  %i_1 = add i13 -1, %i_assign_1
  br label %1

interleaveModMult.exit:                           ; preds = %1
  %Mbar_V = trunc i2052 %p_Val2_s to i2048
  br label %2

; <label>:2                                       ; preds = %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i32, %interleaveModMult.exit
  %p_Val2_1 = phi i2052 [ 0, %interleaveModMult.exit ], [ %P_V_9, %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i32 ]
  %i_assign_2 = phi i13 [ 2048, %interleaveModMult.exit ], [ %i_2, %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i32 ]
  %i_assign_2_cast = sext i13 %i_assign_2 to i32
  %tmp_4 = call i1 @_ssdm_op_BitSelect.i1.i13.i32(i13 %i_assign_2, i32 12)
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2049, i64 2049, i64 2049)
  br i1 %tmp_4, label %interleaveModMult.exit34, label %_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i32
...
_ZlsILi2052ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit.i32: ; preds = %2
  ...
  %tmp_7 = trunc i2052 %p_Val2_1 to i2051
  %P_V_6 = call i2052 @_ssdm_op_BitConcatenate.i2052.i2051.i1(i2051 %tmp_7, i1 %tmp_6)
  %tmp_4_i1 = icmp ult i2052 %P_V_6, %tmp_i
  %P_V_7 = sub i2052 %P_V_6, %tmp_i
  %p_036_1_P_V_2_i1 = select i1 %tmp_4_i1, i2052 %P_V_6, i2052 %P_V_7
  %tmp_5_i1 = icmp ult i2052 %p_036_1_P_V_2_i1, %tmp_i
  %P_V_8 = sub i2052 %p_036_1_P_V_2_i1, %tmp_i
  %P_V_9 = select i1 %tmp_5_i1, i2052 %p_036_1_P_V_2_i1, i2052 %P_V_8
  %i_2 = add i13 -1, %i_assign_2
  br label %2

interleaveModMult.exit34:                         ; preds = %2
  %xbar_V = alloca i2048
  %xbar_V_1 = trunc i2052 %p_Val2_1 to i2048
  store i2048 %xbar_V_1, i2048* %xbar_V
  br label %3

; <label>:3                                       ; preds = %._crit_edge, %interleaveModMult.exit34
  %i_assign = phi i12 [ 2047, %interleaveModMult.exit34 ], [ %i, %._crit_edge ]
  %i_assign_cast = sext i12 %i_assign to i32
  %tmp_8 = call i1 @_ssdm_op_BitSelect.i1.i12.i32(i12 %i_assign, i32 11)
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2048, i64 2048, i64 2048)
  br i1 %tmp_8, label %6, label %4

; <label>:4                                       ; preds = %3
  %xbar_V_load_1 = load i2048* %xbar_V
  %xbar_V_2 = call fastcc i2048 @montMult(i2048 %xbar_V_load_1, i2048 %xbar_V_load_1, i2048 %n_V_read)
  %tmp_9 = call i1 @_ssdm_op_BitSelect.i1.i2048.i32(i2048 %e_V_read, i32 %i_assign_cast)
  br i1 %tmp_9, label %5, label %._crit_edge.pre

; <label>:5                                       ; preds = %4
  %xbar_V_3 = call fastcc i2048 @montMult(i2048 %Mbar_V, i2048 %xbar_V_2, i2048 %n_V_read)
  store i2048 %xbar_V_3, i2048* %xbar_V
  br label %._crit_edge

._crit_edge.pre:                                  ; preds = %4
  store i2048 %xbar_V_2, i2048* %xbar_V
  br label %._crit_edge
...
; <label>:6                                       ; preds = %3
  %xbar_V_load = load i2048* %xbar_V
  %call_ret = call fastcc i2048 @montMult(i2048 %xbar_V_load, i2048 1, i2048 %n_V_read)
...
_ZrsILi2050ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit: ; preds = %1
  %tmp_13 = call i1 @_ssdm_op_BitSelect.i1.i2050.i32(i2050 %X_V, i32 %i_assign_cast1)
  %S_V = add i2050 %Y_V, %p_cast
  %p_Val2_1 = select i1 %tmp_13, i2050 %S_V, i2050 %p_cast
  %tmp_14 = trunc i2050 %p_Val2_1 to i1
  ...
  %tmp_5 = select i1 %tmp_14, i2049 %tmp_3, i2049 %tmp_4
  br label %1

; <label>:2                                       ; preds = %1
  %tmp = icmp ult i2049 %p_s, %M_V_cast
  %tmp_10 = trunc i2049 %p_s to i2048
  %tmp_11 = trunc i2049 %p_s to i2048
  %tmp_12 = sub i2048 %tmp_10, %M0_V_read
  %ssdm_int_V_write_ass = select i1 %tmp, i2048 %tmp_11, i2048 %tmp_12
...
entry:
  ...
  %empty_8 = trunc i2050 %empty to i2049
  ret i2049 %empty_8
}
...
entry:
  ...
  %empty_9 = shl i2050 1, %empty
  %empty_10 = and i2050 %0, %empty_9
  %empty_11 = icmp ne i2050 %empty_10, 0
  ret i1 %empty_11
}
...
entry:
  ...
  %empty_12 = shl i2049 1, %empty
  %empty_13 = and i2049 %0, %empty_12
  %empty_14 = icmp ne i2049 %empty_13, 0
  ret i1 %empty_14
}
...
entry:
  ...
  %empty_15 = shl i2048 1, %empty
  %empty_16 = and i2048 %0, %empty_15
  %empty_17 = icmp ne i2048 %empty_16, 0
  ret i1 %empty_17
}
...
entry:
  ...
  %empty_18 = shl i13 1, %empty
  %empty_19 = and i13 %0, %empty_18
  %empty_20 = icmp ne i13 %empty_19, 0
  ret i1 %empty_20
}
...
entry:
  %empty = zext i2051 %0 to i2052
  %empty_24 = zext i1 %1 to i2052
  %empty_25 = shl i2052 %empty, 1
  %empty_26 = or i2052 %empty_25, %empty_24
  ret i2052 %empty_26
}
