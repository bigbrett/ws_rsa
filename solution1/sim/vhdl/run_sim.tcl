...
if {[file isfile rsaModExp.autotvin.dat]} {
	file delete -force rsaModExp.autotvin.dat
}

if {[file isfile rsaModExp.autotvout.dat]} {
	file delete -force rsaModExp.autotvout.dat
}
