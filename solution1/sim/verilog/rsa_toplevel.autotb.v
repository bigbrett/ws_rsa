...
`define AUTOTB_DUT      rsa_toplevel
`define AUTOTB_DUT_INST AESL_inst_rsa_toplevel
`define AUTOTB_TOP      apatb_rsa_toplevel_top
`define AUTOTB_LAT_RESULT_FILE "rsa_toplevel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "rsa_toplevel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_rsa_toplevel_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 10.00

`define AESL_DEPTH_inData_V 1
`define AESL_DEPTH_outData_V 1
`define AUTOTB_TVIN_inData_V  "../tv/cdatafile/c.rsa_toplevel.autotvin_inData_V.dat"
`define AUTOTB_TVIN_inData_V_out_wrapc  "../tv/rtldatafile/rtl.rsa_toplevel.autotvin_inData_V.dat"
`define AUTOTB_TVOUT_outData_V  "../tv/cdatafile/c.rsa_toplevel.autotvout_outData_V.dat"
`define AUTOTB_TVOUT_outData_V_out_wrapc  "../tv/rtldatafile/rtl.rsa_toplevel.autotvout_outData_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1119238;
parameter LENGTH_inData_V = 1;
parameter LENGTH_outData_V = 1;
