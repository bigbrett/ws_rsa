...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ModExp.autotvin.dat"
	set constFileTvOut       "ModExp.autotvout.dat"
	set constFileHdlTvIn     "ModExp.autohdltvin.dat"
	set constFileHdlTvOut    "ModExp.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
