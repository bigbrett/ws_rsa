...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rsaModExp.autotvin.dat"
	set constFileTvOut       "rsaModExp.autotvout.dat"
	set constFileHdlTvIn     "rsaModExp.autohdltvin.dat"
	set constFileHdlTvOut    "rsaModExp.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
