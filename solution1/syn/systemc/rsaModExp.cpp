...
const sc_lv<11> rsaModExp::ap_const_lv11_3FF = "1111111111";
const sc_lv<1024> rsaModExp::ap_const_lv1024_lc_2 = "1";
const sc_lv<32> rsaModExp::ap_const_lv32_6 = "110";
const sc_lv<32> rsaModExp::ap_const_lv32_A = "1010";
const sc_lv<11> rsaModExp::ap_const_lv11_7FF = "11111111111";
...
void rsaModExp::thread_i_assign_cast_fu_162_p1() {
    i_assign_cast_fu_162_p1 = esl_sext<32,11>(i_assign_reg_77.read());
}

void rsaModExp::thread_i_fu_181_p2() {
    i_fu_181_p2 = (!i_assign_reg_77.read().is_01() || !ap_const_lv11_7FF.is_01())? sc_lv<11>(): (sc_biguint<11>(i_assign_reg_77.read()) + sc_bigint<11>(ap_const_lv11_7FF));
}
...
void rsaModExp::thread_tmp_1_fu_174_p3() {
    tmp_1_fu_174_p3 = (!i_assign_cast_fu_162_p1.read().is_01() || sc_biguint<32>(i_assign_cast_fu_162_p1.read()).to_uint() >= 1024)? sc_lv<1>(): e_V.read().range(sc_biguint<32>(i_assign_cast_fu_162_p1.read()).to_uint(), sc_biguint<32>(i_assign_cast_fu_162_p1.read()).to_uint());
}

void rsaModExp::thread_tmp_fu_166_p3() {
    tmp_fu_166_p3 = i_assign_reg_77.read().range(10, 10);
}
