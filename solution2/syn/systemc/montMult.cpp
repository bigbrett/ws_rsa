...
montMult::montMult(sc_module_name name) : sc_module(name), mVcdFile(0) {
    rsaModExp_add_205dEe_U6 = new rsaModExp_add_205dEe<1,4,2050,2050,2050>("rsaModExp_add_205dEe_U6");
    rsaModExp_add_205dEe_U6->clk(ap_clk);
    rsaModExp_add_205dEe_U6->reset(ap_rst);
    rsaModExp_add_205dEe_U6->din0(Y_V_reg_190);
    rsaModExp_add_205dEe_U6->din1(grp_fu_111_p1);
    rsaModExp_add_205dEe_U6->ce(ap_var_for_const0);
    rsaModExp_add_205dEe_U6->dout(grp_fu_111_p2);
    rsaModExp_sub_204eOg_U7 = new rsaModExp_sub_204eOg<1,4,2048,2048,2048>("rsaModExp_sub_204eOg_U7");
    rsaModExp_sub_204eOg_U7->clk(ap_clk);
    rsaModExp_sub_204eOg_U7->reset(ap_rst);
    rsaModExp_sub_204eOg_U7->din0(grp_fu_129_p0);
    rsaModExp_sub_204eOg_U7->din1(M0_V_read_reg_180);
    rsaModExp_sub_204eOg_U7->ce(ap_var_for_const0);
    rsaModExp_sub_204eOg_U7->dout(grp_fu_129_p2);
    rsaModExp_add_205dEe_U8 = new rsaModExp_add_205dEe<1,4,2050,2050,2050>("rsaModExp_add_205dEe_U8");
    rsaModExp_add_205dEe_U8->clk(ap_clk);
    rsaModExp_add_205dEe_U8->reset(ap_rst);
    rsaModExp_add_205dEe_U8->din0(M_V_reg_195);
    rsaModExp_add_205dEe_U8->din1(p_Val2_1_reg_239);
    rsaModExp_add_205dEe_U8->ce(ap_var_for_const0);
    rsaModExp_add_205dEe_U8->dout(grp_fu_154_p2);
    ...
    sensitive << ( tmp_9_reg_244 );
    sensitive << ( tmp_4_reg_249 );
    sensitive << ( tmp_3_fu_158_p4 );

    SC_METHOD(thread_tmp_6_fu_125_p1);
    sensitive << ( p_s_reg_46 );

    SC_METHOD(thread_tmp_8_fu_104_p3);
    sensitive << ( X_V_reg_185 );
    sensitive << ( i_assign_cast1_fu_88_p1 );

    SC_METHOD(thread_tmp_9_fu_140_p1);
    ...
    sc_trace(mVcdFile, tmp_8_fu_104_p3, "tmp_8_fu_104_p3");
    ...
    sc_trace(mVcdFile, tmp_6_fu_125_p1, "tmp_6_fu_125_p1");
    ...
    sc_trace(mVcdFile, tmp_9_fu_140_p1, "tmp_9_fu_140_p1");
    sc_trace(mVcdFile, tmp_9_reg_244, "tmp_9_reg_244");
...
montMult::~montMult() {
    ...
    delete rsaModExp_add_205dEe_U6;
    delete rsaModExp_sub_204eOg_U7;
    delete rsaModExp_add_205dEe_U8;
}
...
void montMult::thread_p_Val2_1_fu_134_p3() {
    p_Val2_1_fu_134_p3 = (!tmp_8_reg_219.read()[0].is_01())? sc_lv<2050>(): ((tmp_8_reg_219.read()[0].to_bool())? grp_fu_111_p2.read(): p_cast_reg_205.read());
}
...
void montMult::thread_ssdm_int_V_write_ass_fu_174_p3() {
    ssdm_int_V_write_ass_fu_174_p3 = (!tmp_reg_224.read()[0].is_01())? sc_lv<2048>(): ((tmp_reg_224.read()[0].to_bool())? tmp_6_reg_234.read(): grp_fu_129_p2.read());
}
...
void montMult::thread_tmp_5_fu_168_p3() {
    tmp_5_fu_168_p3 = (!tmp_9_reg_244.read()[0].is_01())? sc_lv<2049>(): ((tmp_9_reg_244.read()[0].to_bool())? tmp_3_fu_158_p4.read(): tmp_4_reg_249.read());
}

void montMult::thread_tmp_6_fu_125_p1() {
    tmp_6_fu_125_p1 = p_s_reg_46.read().range(2048-1, 0);
}

void montMult::thread_tmp_8_fu_104_p3() {
    tmp_8_fu_104_p3 = (!i_assign_cast1_fu_88_p1.read().is_01() || sc_biguint<32>(i_assign_cast1_fu_88_p1.read()).to_uint() >= 2050)? sc_lv<1>(): X_V_reg_185.read().range(sc_biguint<32>(i_assign_cast1_fu_88_p1.read()).to_uint(), sc_biguint<32>(i_assign_cast1_fu_88_p1.read()).to_uint());
}

void montMult::thread_tmp_9_fu_140_p1() {
    tmp_9_fu_140_p1 = p_Val2_1_fu_134_p3.read().range(1-1, 0);
}
